...
public class MineverseChat extends JavaPlugin implements PluginMessageListener {
	...
	public static mineverse.Aust1n46.chat.ChatMessage lastChatMessage;
	...
	private mineverse.Aust1n46.chat.LogLevels curLogLevel;
	...
	public void onEnable() {
		...
		new mineverse.Aust1n46.chat.VentureChatPlaceholders().register();
	...
	public void setLogLevel(String loglevel) {
		if(mineverse.Aust1n46.chat.LogLevels.valueOf(loglevel) != null) {
			curLogLevel = mineverse.Aust1n46.chat.LogLevels.valueOf(loglevel);
		}
		else {
			curLogLevel = mineverse.Aust1n46.chat.LogLevels.INFO;
		}
	}

	public void logme(mineverse.Aust1n46.chat.LogLevels level, String location, String logline) {
